  ...
  return (
    <nav className={`fixed w-full z-50 transition-all duration-300 ${scrolled ? 'bg-[#FAF9F6]/90 dark:bg-[#1A1C18]/90 backdrop-blur-md py-4 border-b border-accent/10' : 'bg-transparent py-8 border-b border-transparent'}`}>
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex justify-between items-center">
        {/* Logo & Avatar */}
        <div className="flex items-center space-x-4 rtl:space-x-reverse z-50 relative">
          <img src={qaaPic} alt="Brand Avatar" className="w-20 h-20 rounded-full object-cover border border-accent/20 shadow-sm" />
          <a href="#home" className="text-3xl font-black font-serif tracking-tighter text-accent dark:text-[#E5E1D8]">
            {t('nav.logo')}
          </a>
        </div>
